...
public class Backup extends Entidade{
	...
	private java.util.Date data_backup;
	@Column(nullable = false)
	...
	public java.util.Date getData_backup() {return data_backup;}
	...
	public void setData_backup(java.util.Date data_backup) {this.data_backup = data_backup;}
